<script>
  ...
  import RotateIcon from './Svg/autorenew-24px.svg'
  import ResetIcon from './Svg/restore-24px.svg'
  import DoneIcon from './Svg/done-24px.svg'
...
<button
  ...
  title={iconType}
  aria-label={`This button will ${iconType} timer`}
>
  {#if iconType === 'rotate'}
